...
import numpy as np
import re
from CalendarUtilities import mjd
...
def get_data():
    ...
    # 3D list (365*3*9) that stores (sun, earth, moon) position data for each day of the year
...
def processData(day_num, dailyPositionsArray):
    ...
    X_1 = (float(curSunData[0])) * AU  # -7.139867342351965E-03*AU = -106810895149.63219
